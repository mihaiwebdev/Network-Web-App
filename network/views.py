        ...
        # Return following posts
            ...
            if request.user.is_authenticated:
                ...
                if len(user_following) > 0:
                    ...
                    users_posts = Post.objects.filter(author__in=user_following).all().order_by("-timestamp")
                    ...
                    serialized_following = [post.serialize() for post in following_page.object_list]
